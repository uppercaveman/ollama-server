...
> **Note:** OpenAI compatibility is experimental and is subject to major adjustments including breaking changes. For fully-featured access to the Ollama API, see the Ollama [Python library](https://github.com/uppercaveman/ollama-server-python), [JavaScript library](https://github.com/uppercaveman/ollama-server-js) and [REST API](https://github.com/uppercaveman/ollama-server/blob/main/docs/api.md).
